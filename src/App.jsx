              ...
              <ValidationScreen 
                ...
                onSave={async (newData) => {
                  ...
                  const record = {
                    ...
                    bono_counter:        newData.bono_counter,
                    salidas_especificas: newData.salidas_especificas,
                    minimo_pax:          newData.minimo_pax,
                    punto_encuentro:     newData.punto_encuentro,
                    informacion_traslados: newData.informacion_traslados,
                    documentacion_requisitos: newData.documentacion_requisitos,
                    seguro_viaje:        newData.seguro_viaje,
                    telefono_emergencia: newData.telefono_emergencia,
                    notas_habitacion:    newData.notas_habitacion,
                    excursiones_opcionales: newData.excursiones_opcionales,
